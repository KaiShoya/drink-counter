...
useSeoMeta({
  title: t(LOCALE_TERMS_OF_SERVICE),
})
</script>
...
<template>
  <div class="content">
    <section class="section">
      ...
      <p class="subtitle">
        この利用規約（以下、「本規約」といいます。）は、運営者（Kai Shoya）（以下、「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
      ...
      <h3>第2条（利用登録）</h3>
      <ol>
        <li>本サービスにおいては、登録希望者が本規約に同意の上、運営者の定める方法によって利用登録を申請した時点で、利用登録が完了するものとします。</li>
      ...
      <ol>
        ...
        <li>ユーザーIDおよびパスワードが第三者に使用されたことによって生じた損害は、運営者に故意または重大な過失がある場合を除き、運営者は一切の責任を負わないものとします。</li>
      </ol>
      ...
      <ol>
        ...
        <li>本サービスおよび本サービスに関連する一切の情報についての著作権およびその他の知的財産権はすべて運営者または運営者にその利用を許諾した権利者に帰属し、ユーザーは無断で複製、譲渡、貸与、翻訳、改変、転載、公衆送信、伝送、配布、出版、営業使用等をしてはならないものとします。</li>
      </ol>
      ...
      <h3>第12条（利用規約の変更）</h3>
      <ol>
        <li>運営者は、ユーザーの一般の利益に適合する場合、または契約目的に反せず合理的な場合に、本規約を変更することができるものとします。</li>
        <li>運営者は、前項による本規約の変更にあたり、事前に、変更内容および効力発生時期を通知または本サービス上で公表します。</li>
      </ol>

      <h3>第13条（個人情報の取扱い）</h3>
      <p>運営者は、本サービスの利用によって取得する個人情報については、運営者のプライバシーポリシーに従い適切に取り扱うものとします。</p>
      ...
      <ol>
        ...
        <li>本サービスに関して紛争が生じた場合には、運営者の居住地を管轄する裁判所を専属的合意管轄とします。</li>
      </ol>
    </section>
  </div>
</template>
