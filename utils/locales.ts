...
export const LOCALE_INDEX_WARNING_TITLE = `${LOCALE_INDEX}.warning_title` as const
export const LOCALE_INDEX_WARNING_CONTENT = `${LOCALE_INDEX}.warning_content` as const
...
export const LOCALE_SETTINGS_SWITCHING_TIMING = `${LOCALE_SETTINGS}.switching_timing` as const
...
export const LOCALE_DRINKS_NAME_PLACEHOLDER = `${LOCALE_DRINKS}.name_placeholder` as const
...
export const LOCALE_DRINKS_STANDARD_AMOUNT = `${LOCALE_DRINKS}.standard_amount` as const
export const LOCALE_DRINKS_DRINK_LABEL = `${LOCALE_DRINKS}.drink_label` as const
export const LOCALE_DRINKS_DELETE_MODAL_TITLE = `${LOCALE_DRINKS}.delete_modal_title` as const
export const LOCALE_DRINKS_DELETE_MODAL_CONTENT = `${LOCALE_DRINKS}.delete_modal_content` as const
...
export const LOCALE_DRINKS_SORT_SUCCESS = `${LOCALE_DRINKS}.sort_success` as const
export const LOCALE_DRINKS_SAVE_SORT = `${LOCALE_DRINKS}.save_sort` as const
export const LOCALE_DRINKS_DELETE_SUCCESS = `${LOCALE_DRINKS}.delete_success` as const
export const LOCALE_DRINKS_DELETE_FAILURE = `${LOCALE_DRINKS}.delete_failure` as const
export const LOCALE_DRINKS_CREATE_SUCCESS = `${LOCALE_DRINKS}.create_success` as const
export const LOCALE_DRINKS_CREATE_FAILURE = `${LOCALE_DRINKS}.create_failure` as const
export const LOCALE_DRINKS_UPDATE_SUCCESS = `${LOCALE_DRINKS}.update_success` as const
export const LOCALE_DRINKS_UPDATE_FAILURE = `${LOCALE_DRINKS}.update_failure` as const
...
export const LOCALE_DRINKS_UPDATE_VISIBLE_SUCCESS = `${LOCALE_DRINKS}.update_visible_success` as const
export const LOCALE_DRINKS_COPY_LABEL_COLOR = `${LOCALE_DRINKS}.copy_label_color` as const

const LOCALE_LABELS = 'labels' as const
export const LOCALE_LABELS_NAME_PLACEHOLDER = `${LOCALE_LABELS}.name_placeholder` as const
export const LOCALE_LABELS_STANDARD_AMOUNT = `${LOCALE_LABELS}.standard_amount` as const
...
export const LOCALE_AGGREGATION_SUM_COUNT = `${LOCALE_AGGREGATION}.sum_count` as const
export const LOCALE_AGGREGATION_AVG_COUNT = `${LOCALE_AGGREGATION}.avg_count` as const
export const LOCALE_AGGREGATION_MAX_TYPE_OF_DRINKS = `${LOCALE_AGGREGATION}.max_type_of_drinks` as const
export const LOCALE_AGGREGATION_AVG_TYPE_OF_DRINKS = `${LOCALE_AGGREGATION}.avg_type_of_drinks` as const
export const LOCALE_AGGREGATION_RECORD_COUNT = `${LOCALE_AGGREGATION}.record_count` as const
...
export const LOCALE_GENERAL_UPDATE_SUCCESS = `${LOCALE_GENERAL}.update_success` as const
