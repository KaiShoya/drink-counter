...
import type { MonthlySummaryInput, MonthlySummaryOutput } from '../../../../app/utils/types/monthly'
import { useDrinksStore } from '../../../data/drinks'
import { useDrinkLabelsStore } from '../../../data/drinkLabels'
...
export const useMonthlySummaryStore = defineStore('pages/index/monthlySummary', {
  state: () => ({
    ...
    lastInput: null as MonthlySummaryInput | null,
    data: null as MonthlySummaryOutput | null,
    error: null as string | null,
  }),
  actions: {
    async fetchMonthlySummary(input: MonthlySummaryInput) {
      this.loading = true
      this.error = null
